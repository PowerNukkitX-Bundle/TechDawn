...
import cn.powernukkitx.techdawn.blockentity.dynamic.BaseTransposingGearBoxBlockEntity;
...
public class BaseTransposingGearBoxBlock extends BlockSolidMeta implements CustomBlock, Faceable, BlockEntityHolder<BaseTransposingGearBoxBlockEntity> {
    ...
    public BaseTransposingGearBoxBlock() {
        super(0);
    }

    @SuppressWarnings("unused")
    public BaseTransposingGearBoxBlock(int meta) {
        super(meta);
    }
    ...
    public String getNamespaceId() {
        return "techdawn:base_transposing_gear_box";
    }
    ...
    @NotNull
    @Override
    public Class<? extends BaseTransposingGearBoxBlockEntity> getBlockEntityClass() {
        return BaseTransposingGearBoxBlockEntity.class;
    }
