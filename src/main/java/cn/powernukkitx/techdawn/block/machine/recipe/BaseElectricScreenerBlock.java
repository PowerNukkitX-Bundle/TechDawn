...
public class BaseElectricScreenerBlock extends BlockSolidMeta implements Faceable, CustomBlock, BlockEntityHolder<BaseElectricScreenerBlockEntity>, TechDawnWorkableBlock {
    ...
    public BaseElectricScreenerBlock() {
        this(0);
    }

    public BaseElectricScreenerBlock(int meta) {
        super(meta);
    }
    ...
    public String getNamespaceId() {
        return "techdawn:base_electric_screener";
    }

    @Override
    public CustomBlockDefinition getDefinition() {
        return CustomDefUtil.get4DirectionWorkingMachineDef(this,
                "techdawn-blocks-machine-basic_electric_screener_on",
                "techdawn-blocks-machine-basic_electric_screener_off",
                "techdawn-blocks-machine-basic_electric_machine_top",
                "techdawn-blocks-machine-basic_machine",
                "techdawn-blocks-machine-basic_electric_screener_bottom");
    }
    ...
    @NotNull
    @Override
    public Class<? extends BaseElectricScreenerBlockEntity> getBlockEntityClass() {
        return BaseElectricScreenerBlockEntity.class;
    }
