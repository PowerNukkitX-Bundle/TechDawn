...
public class BaseElectricExtractorBlock extends BlockSolidMeta implements Faceable, CustomBlock, BlockEntityHolder<BaseElectricExtractorBlockEntity>, TechDawnWorkableBlock {
    ...
    public BaseElectricExtractorBlock() {
        this(0);
    }

    public BaseElectricExtractorBlock(int meta) {
        super(meta);
    }
    ...
    public String getNamespaceId() {
        return "techdawn:base_electric_extractor";
    }

    @Override
    public CustomBlockDefinition getDefinition() {
        return CustomDefUtil.get4DirectionWorkingBasicMachineDef(this,
                "techdawn-blocks-machine-basic_extractor_on", "techdawn-blocks-machine-basic_extractor_off");
    }
    ...
    @NotNull
    @Override
    public Class<? extends BaseElectricExtractorBlockEntity> getBlockEntityClass() {
        return BaseElectricExtractorBlockEntity.class;
    }
