...
public abstract class BaseNugget extends ItemCustom implements TechDawnHardness {
    public BaseNugget(@NotNull String id) {
        super(id, null, "techdawn-items-nugget-" + id.substring(id.lastIndexOf(":") + 1));
    }
