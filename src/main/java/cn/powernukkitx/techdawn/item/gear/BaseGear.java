...
public abstract class BaseGear extends ItemCustom implements TechDawnHardness {
    public BaseGear(@NotNull String id) {
        super(id, null, "techdawn-items-gear-" + id.substring(id.lastIndexOf(":") + 1));
    }
